// EmojiPasta code from https://github.com/Kevinpgalligan/KevingalWebsite/tree/master/static/js/apps/emojipasta

const EMOJI_MAPPINGS = require('./emoji-mappings')
...
function generateEmojisFrom(block) {
    ...
    var emojis = [];
    if (matchingEmojis) {
        var numEmojis = Math.floor(Math.random() * (MAX_EMOJIS_PER_BLOCK + 1)) + 1;
